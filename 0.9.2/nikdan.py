...
while True:
    ...
    if command == 'help':
        ...
        print('asave [arg]   : saves file as readable to nikdan, and as is')
        ...
        print('flist         : lists all siblings')
        print('flistspec     : lists all siblings with additional information')
        print('tribute       : toggles cursor to be the first letter of a random queen member')
        print('fcreate [arg] : creates folder')
        print('fdelete [arg] : deletes folder')
        print('fgoto [arg]   : goes to specified folder')
    ...
    if command == 'delete':
        if os.path.exists(cdir + sec_word):
            if os.path.isfile(cdir + sec_word):
                ...
                print('file deletion unsuccessful, is not folder')
        else:
            print('file deletion unsuccessful, file does not exist')
